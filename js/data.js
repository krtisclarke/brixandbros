...
(function () {
  ...
  G.LEVELS = [
    ...
    },
    {
      ...
      water: [{ x: 1100, y: 250, r: 105 }, { x: 110, y: 255, r: 70 }],
    ...
    },
    {
      ...
      water: [{ x: 1500, y: 748, r: 88 }, { x: 620, y: 318, r: 70 }],
    ...
    },
    {
      ...
      water: [{ x: 700, y: 740, r: 85 }, { x: 120, y: 600, r: 95 }, { x: 1450, y: 600, r: 100 }],
    ...
    },
    {
      ...
      water: [{ x: 900, y: 700, r: 120 }, { x: 150, y: 640, r: 120 }, { x: 1330, y: 400, r: 70 }],
  ...
  const THEME_EXTRAS = {
    ...
    shores:  { snow: '#4E9E48', ice: '#357B36', pathColor: '#6b7076', pathEdge: '#4a4f55', pathCore: '#7c8188', deep: '#2f8fd6', shore: '#79c8ee', props: 'pines' },
    pass:    { snow: '#4B9945', ice: '#327433', pathColor: '#6b7076', pathEdge: '#4a4f55', pathCore: '#7c8188', deep: '#2f79c2', shore: '#74c0ea', props: 'pines' },
    river:   { snow: '#4A9E4E', ice: '#317A3B', pathColor: '#6e737a', pathEdge: '#4c5158', pathCore: '#80858c', deep: '#1391b8', shore: '#6fcfe0', props: 'reeds' },
    alley:   { snow: '#479747', ice: '#2F7334', pathColor: '#686d73', pathEdge: '#474c52', pathCore: '#797e85', deep: '#1f78c4', shore: '#72c4ee', props: 'floes' },
    village: { snow: '#53A94F', ice: '#38833B', pathColor: '#72777e', pathEdge: '#50555c', pathCore: '#848990', deep: '#2f8fd6', shore: '#79c8ee', props: 'village' },
    ...
    ridge:   { snow: '#4D9E4A', ice: '#337A37', pathColor: '#6b7076', pathEdge: '#4a4f55', pathCore: '#7c8188', deep: '#2b6cc0', shore: '#74bcea', props: 'pines' },
    bay:     { snow: '#469A54', ice: '#2E783E', pathColor: '#6b7076', pathEdge: '#4a4f55', pathCore: '#7c8188', deep: '#0f83a6', shore: '#6ccbd2', props: 'bay' },
    peak:    { snow: '#519E4C', ice: '#357B38', pathColor: '#6b7076', pathEdge: '#4a4f55', pathCore: '#7c8188', deep: '#2f79c2', shore: '#74c0ea', props: 'dead' },
    workshop: { snow: '#449243', ice: '#2C6E33', pathColor: '#6b7076', pathEdge: '#4a4f55', pathCore: '#7c8188', deep: '#2361b4', shore: '#6eb6ea', props: 'workshop' },
  ...
  G.DECO_ZONES = {
    shores: [{ x: 400, y: 260, w: 250, h: 90 }, { x: 790, y: 690, r: 70 }, { x: 905, y: 670, r: 60 }],
    pass: [{ x: 320, y: 162, w: 560, h: 88 }, { x: 350, y: 352, w: 580, h: 88 },
      { x: 536, y: 544, w: 172, h: 84 }, { x: 1205, y: 420, r: 90 }, { x: 60, y: 470, r: 70 }],
    river: [{ x: 300, y: 415, r: 60 }, { x: 680, y: 415, r: 55 }, { x: 218, y: 190, w: 170, h: 60 },
      { x: 606, y: 188, w: 172, h: 60 }, { x: 905, y: 598, w: 150, h: 84 }],
    alley: [{ x: 40, y: 150, r: 85 }, { x: 40, y: 650, r: 85 }, { x: 118, y: 62, r: 55 }, { x: 96, y: 748, r: 55 }],
    village: [{ x: 640, y: 96, r: 60 }, { x: 620, y: 500, r: 130 }, { x: 320, y: 212, w: 640, h: 100 }],
    caves: [{ x: 336, y: 152, w: 570, h: 92 }],
    ridge: [{ x: 640, y: 400, r: 125 }],
    ...
    workshop: [{ x: 1120, y: 528, r: 165 }, { x: 300, y: 185, w: 150, h: 82 }],

    flats: [{ x: 850, y: 690, r: 110 }, { x: 1250, y: 730, r: 65 }, { x: 1290, y: 170, r: 70 }],
    fjord: [{ x: 640, y: 150, r: 65 }, { x: 200, y: 150, r: 50 }],
    cataracts: [{ x: 890, y: 490, r: 90 }, { x: 110, y: 328, w: 220, h: 46 }],
    shelf: [{ x: 690, y: 480, w: 420, h: 150 }, { x: 180, y: 610, r: 60 }, { x: 1250, y: 690, r: 65 }],
    rookery: [{ x: 215, y: 180, w: 240, h: 125 }, { x: 210, y: 790, r: 90 }, { x: 1000, y: 300, r: 50 }, { x: 600, y: 285, r: 145 }],
    ...
    longdark: [{ x: 1140, y: 150, r: 175 }, { x: 290, y: 120, r: 110 }],

    approach: [{ x: 400, y: 872, r: 150 }, { x: 155, y: 880, r: 90 }, { x: 645, y: 880, r: 90 }],
    causeway: [{ x: 780, y: 400, w: 330, h: 170 }, { x: 545, y: 620, r: 60 }],
    trench: [{ x: 660, y: 655, r: 175 }],
    obsidian: [{ x: 694, y: 28, w: 140, h: 396 }, { x: 1545, y: 128, r: 70 }],
    cathedral: [{ x: 570, y: 190, w: 590, h: 100 }, { x: 570, y: 596, w: 590, h: 100 }],
    maelstrom: [{ x: 668, y: 210, w: 292, h: 160 }],
    icefall: [{ x: 130, y: 8, w: 510, h: 116 }, { x: 880, y: 8, w: 460, h: 116 }, { x: 320, y: 698, w: 310, h: 108 }],
    blackice: [{ x: 290, y: 200, w: 1030, h: 62 }, { x: 410, y: 524, w: 460, h: 62 },
      { x: 990, y: 709, w: 350, h: 62 }, { x: 450, y: 62, r: 55 }, { x: 1500, y: 598, r: 55 }],
